	...
	<view class="raiders_zone">
		<view class="raiders_bg">
			...
			<view class="treasure" @click="voucherRule=true" >
				<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/rule.png" mode="widthFix"></image><text class="text_rule">夺宝规则</text>
			</view>
		</view>
		<!-- 夺宝规则 -->
		<view class="wrap_flex_bg" v-if="voucherRule">
			<view class="rule_bdi">
				<image class="shut_down" @click="voucherRule=false" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/border_close.png" mode="widthFix"></image>
		...
		<view class="consumption" v-if="consumptionRule">
			<view class="middle_content">
				<image class="shut_down" @click="consumptionRule=false" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/border_close.png" mode="widthFix"></image>
