	...
	<view class="bg">
		<view class="top flex_between">
			<view class="search flex_center">
				<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/search.png" mode="widthFix"></image>
		...
		<view class="nav">
			...
			<image class="nav-img" @click="onClickClass" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/more.png"></image>
		</view>
		<block v-if="navTabListIndex==0">
			...
			<view class="box-wrapper">
				<view class="box-wrapper-list" v-for="item in boxWrapper" :key="item" @click="boxWrapperFun(item)">
					...
					<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/right.png" class="box-wrapper-list-img"></image>
				</view>
			</view>
			<!-- tab切换 -->
	...
	export default{
		data() {
			return {
				...
				// 推荐栏数据
				boxWrapper:[
					{title:'每日爆品',bg:'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/shape1.png',url:'',key:'dailyHot'},
					{title:'商家自营',bg:'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/shape2.png',url:'',key:'merchant'},
					{title:'链客直营',bg:'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/shape3.png',url:'',key:'selfManage'},
					// {title:'一乡一品',bg:require('https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/shape4.png'),url:'',key:''},
					// {title:'免税商品',bg:require('https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/shape5.png'),url:'',key:''},
					// {title:'夺宝专区',bg:require('https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/shape6.png'),url:'',key:'draw'}
				],
				//产品数据
				navList:[],
				//屏幕宽度
...
<style lang="scss" scoped>
	...
	.hot-title{
		...
		&::before,&::after{
			...
			width: 35rpx;
			height: 26rpx;
			background: url(https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/hot.png);
