					...
					<view class="detail-shop">
						<view class="shop-title">
							...
							<view class="shop-enter" @click.stop="jumpShop(item.merchantId)" v-if="!shop">
								进店
								<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/more_gray.png" class="shop-right"></image>
							</view>
						</view>
						<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/cartlist.png" class="shop-img" @click.stop="clickSpecs(item.id)"></image>
					</view>
				</view>
			</view>
		</view>
