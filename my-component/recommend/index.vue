	...
	<view class="recommend">
		<view class="top fz-14 flex_between" @click="goList">
			<view class="flex_center">
				<image class="pic" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/home/recommend.png" mode="widthFix"></image>
				<view class="">推荐商家</view>
			</view>
			<image class="more" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/more_gray.png" mode="widthFix" v-if="recommendList.length>0"></image>
		</view>
		...
		<view class="no_data flex_center" v-if="recommendList.length==0">
			<image class="no_img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/operation/merchant_none.png" mode="widthFix"></image>
			<view class="tip">
			...
			.scroll-item{
				...
				.shop{
					...
					.discount{
						width: 44rpx;
						height: 60rpx;
						background: url(https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/home/discount.png) no-repeat;
