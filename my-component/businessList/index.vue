				...
				<view class="item flex_center" v-for="item in list" :key="item.id" @click="goStoreDetail(item)">
					...
					<view class="item-right">
						...
						<view class="address flex_center">
							<view><image class="location" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/location.png" mode="widthFix"></image></view>
							<view class="fz-12">{{item.contactAddress}}</view>
						</view>
						<view class="heat flex_center">
							<view class="flex_center">
								<view><image class="heat_pic" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/heat.png" mode="widthFix"></image></view>
								<view class="fz-12">{{item.pageViews}}</view>
							</view>
							<view class="flex_center comment">
								<view><image class="heat_pic" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/order_quantity.png" mode="widthFix"></image></view>
