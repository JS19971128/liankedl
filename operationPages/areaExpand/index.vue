	...
	<view class="bg">
		<view class="top flex_between">
			<view class="search flex_center">
				<view><image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/search.png" mode="widthFix"></image></view>
		...
		<view class="no_data flex_center" v-if="noData">
			<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/operation/expand_none.png" mode="widthFix"></image>
			<view class="tip">
		...
		<view class="main" v-else>
			<view class="item flex_center" v-for="item in list" :key="item.id">
				<view class="item-left flex_center">
					<!-- #ifdef MP-ALIPAY -->
					<view><image :src="item.aliAvatar || 'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/avatar.png'" mode="widthFix"></image></view>
					<!-- #endif -->
					<!-- #ifdef MP-WEIXIN -->
					<view><image :src="item.wechatHeadImg || 'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/avatar.png'" mode="widthFix"></image></view>
					<!-- #endif -->
				</view>
						...
						if(data.length>0){
							data.forEach(item=>{
								...
								if (item.starExplain == null) {
									item.starIcon = 'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/star.png'
								}
								if (item.starExplain == "一星拓展员") {
									item.starIcon = 'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/star.png'
								}
								if (item.starExplain == "二星拓展员") {
									item.starIcon = 'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/moon.png'
								}
								if (item.starExplain == "三星拓展员") {
									item.starIcon = 'https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/sun.png'
								}
							})
