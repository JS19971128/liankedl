	...
	<view class="info fz-14" v-show="ifShow">
		<view class="main">
			...
			<view class="item flex_center">
				...
				<view class="item-content">{{form.comType|merchantType}}</view>
			</view> 
			<!-- 经营类型 -->
			<view class="item flex_center">
				<view class="item-name">经营类目</view>
				<view class="item-content">{{form.industryName}}</view>
			</view> 
			<!-- 经营行业 -->
<!--			<view class="item flex_center">-->
...
<!--			</view> -->
			...
			<view class="item flex_center">
				...
				<view class="item-content">{{form.regAddr}}</view>
			</view> 
			<!-- 商家名称 -->
			<view class="item flex_center">
				<view class="item-name">商家名称</view>
				<view class="item-content">{{form.companyName}}</view>
			</view>
			<!-- 商家简称 -->
			<view class="item flex_center">
				<view class="item-name">商家简称</view>
				<view class="item-content">{{form.shortName}}</view>
			</view>
			<!-- 注册号 -->
			<view class="item flex_center">
				<view class="item-name">注册号</view>
				<view class="item-content">{{form.socialCreditCode}}</view>
			</view>
			<!-- 经营资质 -->
			<view class="item flex_center">
