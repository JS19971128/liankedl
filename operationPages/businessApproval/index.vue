				...
				<view class="item flex_center">
					...
					<view class="item-content ">
						<view class="flex_between">
							...
							<view>
								<image class="more" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/xiala.png" mode="widthFix"></image>
							</view>
						</view>
					</view>
				</view>
				...
				<view class="item flex_center">
					...
					<view class="item-content">
						<view class="flex_between">
							...
							<view>
								<image class="more" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/more_gray.png" mode="widthFix"></image>
							</view>
						</view>
					</view>
				</view>
