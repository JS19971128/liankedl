	...
	<view class="container">
		...
		<view class="" v-if="status">
			<view class="main flex_center">
				<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/business/pass.png" mode="widthFix"></image>
				<view class="tip">
					<view class="fz-14">进件审核已通过</view>
					<view class="fz-12">现在可以正式在链客商业联盟中获取收益啦~</view>
				</view>
			</view>
