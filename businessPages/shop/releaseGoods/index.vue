<template>
	<view class="release">
		<view class="release-img">
			<image :src="releaseImg[0] || '../https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/img.png'" @click="clickUrl('/businessPages/shop/releaseGoods/UPImg')" class="item-img"></image>
		...
		<view class="release-btns flex_center">
			...
			<view class="release-btns-release btn flex_center" style="color: #FFFFFF; background-color: #D3D3D3;">暂停发布</view>
		</view>
		<w-picker
			mode="linkage" 
			:visible.sync="show" 
