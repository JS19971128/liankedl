	...
	<view class="releaseSpecs">
		<view class="main" v-for="(item,index) in specificationParamList" :key="index">
			<view class="item flex_between">
				<view class="title"><image class="item-title-img" @click="clickPerent(index)" src="../https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/reduce.png"
			...
			<view class="item flex_between" v-for="(val,idx) in item.values" :key="index">
				<view class="title">
					<image class="item-title-img" @click="clickPlus(index)" src="../https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/plus.png" v-if="idx === 0"></image>
					<image class="item-title-img" @click="clickReduce(index,idx)" src="../https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/reduce.png"
