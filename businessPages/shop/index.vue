			...
			<view class="shop-label-item">
				<view class="shop-label-list" @click="onClickUrl('/businessPages/shop/goodsManage')">
					<view class="shop-label-list-icon">
						<image class="shop-label-list-icon-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/goods.png"></image>
					</view>
				...
				<view class="shop-label-list" @click="onClickUrl('/businessPages/shop/releaseGoods/index')">
					<view class="shop-label-list-icon">
						<image class="shop-label-list-icon-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/releasegoods.png"></image>
					</view>
					<view class="shop-label-list-txt">发布商品</view>
				</view>
				<view class="shop-label-list" @click="onClickUrl('/businessPages/shop/order')">
					<view class="shop-label-list-icon">
						<image class="shop-label-list-icon-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/order.png"></image>
					</view>
					<view class="shop-label-list-txt">商城订单</view>
				</view>
				<view class="shop-label-list">
					<view class="shop-label-list-icon">
						<image class="shop-label-list-icon-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/pj.png"></image>
					</view>
