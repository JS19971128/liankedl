			...
			<view class="my_coin" >
				<view class="left_num" @click="goBankCardList">
					<view class="my_coin_text">
						<view class="arrive"><text>到账银行卡</text><image v-if="list" class="wallet_icon" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/bank.png" mode="aspectFill"></image></view>
					</view>
					<view class="number_withdraw flex_between">
						...
						<image class="image_common" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/more_gray.png" mode="aspectFill"></image>
					</view>
				</view>
				...
				<view class="flex_between">
					<view class="left_list_img">
						<view class="detail_icon">
							<image class="balance_img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/balance.png" mode="aspectFill"></image>
						</view>
						<view class="flex">
