<template>
	<view class="bg">
		...
		<!-- <view class="goods-list hot" v-else-if="navIndex===2">
			<image class="hot-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/business/codebg.png"></image>
			...
			.goodsNav-list{
				...
				&:first-child{
					...
					&::before{
						...
						height: 14rpx;
						content: "";
						background: url(https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/all.png) no-repeat;
					...
					&.up{
						&::before{
							background: url(https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/up.png) no-repeat;
							background-size: 10rpx 14rpx;
						}
					}
					&.down{
						&::before{
							background: url(https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/down.png) no-repeat;
							background-size: 10rpx 14rpx;
						}
					}
				}
