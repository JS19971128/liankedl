	...
	<view class="cart">
		...
		<view class="cart-shop" v-for="(item,index) in cartArr" :key="item.merchantId">
			<view class="shop-title">
				...
				<image class="shop-title-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/more-right.png" mode="widthFix"></image>
			</view>
							...
							<view class="goods-detail-home">
								...
								<view class="goods-detail-specs" v-if="goods.stockStatus=='onSale' && goods.commodityDeleteFlag == 0 && goods.specName">
									<view class="goods-detail-specs-info" @click.stop="onClickSpec(goods.id,goods.commodityId,goods.specId,goods.commodityNum)">
										...
										<image class="specs-more" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/shop/more-up.png" mode="widthFix"></image>
									</view>
