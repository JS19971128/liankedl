		...
		<view class="main" v-if="offline">
			...
			<view class="order_info fz-12">
				...
				<view class="flex_center item">
					...
					<view class="content flex_center">
						<view class="phone">
							<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/phone.png" mode="widthFix"></image>
						</view>
			...
			<view class="main">
				<view class="shop">
					<view class="shop-detail">
						<image class="shop-img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/business/codebg.png"></image>
