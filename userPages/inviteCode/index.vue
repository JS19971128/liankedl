...
<style lang="scss" scoped>
	.bg{
		...
		background: url('https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/bg2.png') no-repeat;
		background-size: 100% 100%;
		.invite_bg{
			width: 710rpx;
			height: 435px;
			background: url(https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/bg3.png) no-repeat;
			background-size: 100% 100%;
			margin: 0 auto;
			.top{
				width: 630rpx;
