			...
			<view class="item flex_between">
				...
				<view class="content">
					<view class="avatar">
						...
						<image src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/my/avatar.png" mode="widthFix" v-else></image>
						<!-- #endif -->
						<!-- #ifdef MP-WEIXIN -->
	...
	export default{
		...
		methods:{
			...
			bindTypeChange(e){
				...
				console.log(userInfo,this.$store.state.userInfo,'uI')
				this.$store.commit('SETUSERINFO',userInfo);
				console.log(this.$store.state.userInfo,'uI')
