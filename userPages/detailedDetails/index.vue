	...
	<view class="detail_details">
		<view class="info_show">
			<view class="top_avatar">
				<image class="src_image_avatar" v-if="findOne.remark == '余额提现' || findOne.remark == '零钱提现' || findOne.remark == '提现退款'" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/balance.png" mode="aspectFill"></image>
