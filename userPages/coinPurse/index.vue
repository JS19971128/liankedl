		...
		<view class="wrap_nuxt">
			<view class="my_coin flex_between" >
				...
				<view class="right_detail" @click="goCoinList">
					<text class="text_more">零钱明细</text><image class="image_common" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/more_gray.png" mode="widthFix"></image>
				</view>
			</view>
				...
				<view class="flex_between">
					<view class="left_list_img">
						<view class="detail_icon">
							<image v-if="item.remark == '提现退款' || item.remark == '余额提现' || item.remark == '零钱提现'" class="balance_img" src="https://lianketong.oss-cn-shenzhen.aliyuncs.com/wx_images/common/balance.png" mode="aspectFill"></image>
